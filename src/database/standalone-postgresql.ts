export type StandalonePostgresql = {
  id: number; // bigserial, not null
  uuid: string; // varchar(255), not null
  name: string; // varchar(255), not null
  description: string | null; // varchar(255), nullable
  postgres_user: string; // varchar(255), not null
  postgres_password: string; // text, not null
  postgres_db: string; // varchar(255), not null
  postgres_initdb_args: string | null; // varchar(255), nullable
  postgres_host_auth_method: string | null; // varchar(255), nullable
  init_scripts: any | null; // json, nullable
  ...
  postgres_conf: string | null; // text, nullable
