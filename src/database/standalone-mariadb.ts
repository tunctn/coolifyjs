export type StandaloneMariadb = {
  id: number; // bigserial, not null
  uuid: string; // varchar(255), not null
  name: string; // varchar(255), not null
  description: string | null; // varchar(255), nullable
  mariadb_root_password: string; // text, not null
  mariadb_user: string; // varchar(255), not null
  mariadb_password: string; // text, not null
  mariadb_database: string; // varchar(255), not null
  mariadb_conf: string | null; // text, nullable
