export type StandaloneMysql = {
  id: number; // bigserial, not null
  uuid: string; // varchar(255), not null
  name: string; // varchar(255), not null
  description: string | null; // varchar(255), nullable
  mysql_root_password: string; // text, not null
  mysql_user: string; // varchar(255), not null
  mysql_password: string; // text, not null
  mysql_database: string; // varchar(255), not null
  mysql_conf: string | null; // text, nullable
